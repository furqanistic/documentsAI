    ...
    <div className='max-w-6xl mx-auto'>
      ...
      >
        <p className='text-base text-gray-600 mb-3'>
          Welcome to Documnt. These terms and conditions outline your rights and
          responsibilities when using our AI-powered document creation platform.
          By using Documnt, you agree to be bound by these terms.
        </p>
      </motion.div>
    ...
    <div className='min-h-screen bg-white'>
      <div className='max-w-6xl mx-auto px-4 py-8'>
        ...
        <div>
          ...
          >
            <Paragraph>
              To use Documnt's services, you must create an account and agree to
              these terms:
            </Paragraph>
          ...
          >
            <Paragraph>
              Documnt offers various subscription plans for accessing our
          ...
          >
            <Paragraph>
              Understanding content ownership is crucial when using Documnt:
            </Paragraph>

            <SubSection title='Your Content'>
              <Paragraph>
                You retain ownership of any original content you upload or
                create using Documnt. By using our service, you grant us a
                license to process, store, and display your content as necessary
                to provide the service.
              </Paragraph>
            </SubSection>

            <SubSection title='Documnt Platform'>
              <Paragraph>
                The Documnt platform, including its software, design, templates,
            ...
            <SubSection title='Feedback'>
              <Paragraph>
                Any feedback, suggestions, or ideas you provide about Documnt
          ...
          >
            ...
            <SubSection title='Content Ownership'>
              <Paragraph>
                Content generated by Documnt's AI based on your inputs is owned
            ...
            <SubSection title='Usage Rights'>
              <BulletList
                items={[
                  ...
                  'Attribution to Documnt is appreciated but not required',
                ]}
              />
            </SubSection>
          ...
          >
            <Paragraph>
              You agree not to use Documnt for any prohibited purposes:
            </Paragraph>
            ...
            <SubSection title='Content Standards'>
              <Paragraph>
                All content created with Documnt must be appropriate for
          ...
          >
            ...
            <BulletList
              items={[
                'Documnt is provided "as is" without warranties',
          ...
          >
            ...
            <SubSection title='Disclaimer'>
              <Paragraph>
                Documnt is not liable for any indirect, incidental, special,
            ...
            <SubSection title='Liability Cap'>
              <Paragraph>
                ...
                Documnt in the 12 months preceding the claim.
              </Paragraph>
            </SubSection>

            <SubSection title='Indemnification'>
              <Paragraph>
                You agree to indemnify Documnt against any claims arising from
          ...
          >
            ...
            <SubSection title='Effect of Termination'>
              <Paragraph>
                Upon termination, your right to use Documnt ceases immediately.
