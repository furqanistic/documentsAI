...
const SidebarCreateDocument = () => {
  ...
  return (
    ...
    >
      ...
      >
        <h3 className='text-lg font-bold mb-5 flex items-center text-gray-800'>
          Features
        </h3>
        <ul className='space-y-4'>
          {features.map((feature, index) => (
            ...
            >
              ...
              <div>
                <span className='text-sm font-medium block mb-0.5 text-gray-800'>
                  {feature.text}
                </span>
      ...
      >
        ...
        <div className='space-y-4'>
          <p className='text-sm text-gray-700'>
            Convert your generated exams into interactive online tests with a
            single click:
          </p>
          ...
          <button className='w-full mt-2 text-sm bg-gray-900 text-white py-3 rounded-lg font-medium flex items-center justify-center hover:bg-gray-800 transition-all shadow-sm'>
